...
# So the collide thing needs a little work, and then I need to actually build all the collidable things and pass it
#   to Mario. Creating the things could probably be done with a function since I know all the locations and sizes
class Mario(Sprite):
    def __init__(self, screen, platforms, camera):
        ...
        self.width = 17
        self.height = 16
        self.jump = pygame.mixer.Sound('images/smb_jumpsmall.wav')
